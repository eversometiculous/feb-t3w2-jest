...
describe("Casual tabletop gamers wants to...", () =>{
...
//        console.log("rollResult = \n" + rollResult.finalResult + ", " + rollResult.rolls); or you can do
        ...
        let sortedRolls = [...rollResult.rolls].sort(a, b) => a - b;
...
//        console.log("rollResult = \n" + rollResult.finalResult + ", " + rollResult.rolls); or you can do
    ...
    describe("...wants to roll a variety of dice. Specfically, they want to roll a ...", () => {
...
//		test("D6", () => {
//            let diceResult = rollDice();
//            // let diceResult = rollDice(6); equivalent to the line above
//            expect(diceResult).toBeGreaterThan(0);
//            expect(diceResult).toBeLessThanOrEqual(6);
//		});
